...
from pycrate_mobile.NAS import FGMMRegistrationRequest, FGMMMODeregistrationRequest, FGMMRegistrationComplete, \
    FGMMAuthenticationResponse, FGMMSecProtNASMessage, FGMMSecurityModeComplete
...
def security_prot_encrypt_ciphered(CiphAlgo,  IntegAlgo ,k_nas_enc, k_nas_int, Msg):
    try:
        IEs = {}
        if CiphAlgo != 0:
